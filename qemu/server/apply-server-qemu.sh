...
SECRETS_FILE="${REPO_ROOT}/vars/secrets.fake.yml"
PLAYBOOK="${REPO_ROOT}/play-server.yml"
SSH_HOST="127.0.0.1"
SSH_PORT="2222"
SSH_USER="arch"
...
Usage:
  qemu/server/apply-server-qemu.sh [options] [-- <additional ansible-playbook args>]
...
TARGET_SECRETS="${REPO_ROOT}/vars/secrets.yml"
BACKUP_SECRETS=""
...
run_ssh "sudo bash -s" < "${SCRIPT_DIR}/scripts/bootstrap-serial-console.sh"
